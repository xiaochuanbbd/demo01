<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" style="cursor: pointer;" @click="changeAddress(address)" v-for="(address, index) in userAddressList" :key="address.id">
    ...
    methods:{
     ...
     async submitOrder(){
        ...
        let tradeInfo = {
          ...
          consigneeTel:this.defaultAddress.consigneeTel,
          deliveryAddress:this.defaultAddress.deliveryAddress,
