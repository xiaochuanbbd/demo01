  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <img ref="code" src="/api/user/passport/code" @click="changeCode" alt="code" />
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
...
<script>
  export default {
    ...
    if(mobile && code && password&&password2 && password2===password){
      try {
          await this.$store.dispatch("getUserRegister",{mobile,code,password});
