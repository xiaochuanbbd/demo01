<template>
  <div class="cart">
    ...
    <div class="cart-main">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="(cart, index) in shopCartList" :key="index">
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a href="#none" @click="allDeleteCart">删除选中的商品</a>
      ...
      <div class="money-box">
        ...
        <div class="sumbtn">
          ...
          <!-- <a class="sum-btn" href="javascript:;" target="_blank" @click="" >结算</a> -->
        </div>
      </div>
    </div>
  </div>
...
import { mapGetters, mapState } from 'vuex'
  export default {
    ...
    methods:{
     ...
     try {
      await  this.$store.dispatch('getupdateCartIsChecked',{skuId:cart.skuId,isChecked:cart.isChecked?0:1})
        this.getShopCartList()
     } catch (error) {
  ...
  isAllCheck:{
   ...
   async set(val){
     try {
       await this.$store.dispatch('updateAllCartIsChecked',val?1:0)
       this.getShopCartList()
